...
def get_plant_info(plantUrl):
    ...
    print(f'Alt Name: {alt_name}.title()')
    ...
    return plant_name, alt_name.title(), eventual_spread, eventual_height, plant_position, soil_type, growth_rate, plant_hardiness, home_care.replace('  ', ' '), plant_hazard
